...
public class view extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            File file=new File(request.getServletContext().getAttribute("FILES_DIR")+File.separator+temp);
            File[] list=file.listFiles();
            for(File f:list)
            {
                out.println("<br>");
                out.println("<a href=\"download?fileName="+f.getName()+"&&location="+temp+"\">"+f.getName()+"</a>");
                out.println("<a href=\"delete?fileName="+f.getName()+"&&location="+temp+"\">delete"+"</a>");
            }
        }
    }
