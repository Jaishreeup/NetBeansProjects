...
public class dataentry extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<h1 align=center>timetable generation software</h1><br>");
            out.println("<a href=google.com>create  timetable</a><br>");
            out.println("<a href=google.com>view  timetable</a>");
            out.println("");
            out.println("</body>");
            out.println("</html>");
        }
